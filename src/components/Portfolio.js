...
const Portfolio = () => {
  ...
  const projects = [
    ...
    {
      title: "PurPet",
      description: "​Pür Pet creates eco-friendly, vet-approved pet products focused on comfort, style, wellness, and orthopedic support for modern pets.",
      link: "https://purpetco.com/",
      image: `${process.env.PUBLIC_URL}/pur-pet.png`,
    },
    {
      title: "Elite honey",
      description: "​Pür Pet creates eco-friendly, vet-approved pet products focused on comfort, style, wellness, and orthopedic support for modern pets.",
    ...
    <div className="portfolio-container">
      ...
      <div className="portfolio-bottom">
        ...
        <div className="all-link">
          ...
          <a className="link-website" href="https://novatechgaming.com/" target="_blank" rel="noopener noreferrer">Nova Techgaming</a>
